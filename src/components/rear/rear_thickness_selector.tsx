...
import { RearPitchSelector } from ".";

interface IRearThicknessSelectorProps {
    poly: Polyglot;
    language: string;
}
...
interface IRearThicknessSelectorState {
    selectedDrawing: number;
}

export class RearThicknessSelector extends React.Component<IRearThicknessSelectorProps, IRearThicknessSelectorState> {
    ...
    constructor(props: IRearThicknessSelectorProps) {
        super(props);
