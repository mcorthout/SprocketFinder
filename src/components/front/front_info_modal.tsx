...
import { ISprocket, IFrontSprocketInfo } from "../../models";
import { ImageModal } from "../../common";
import { Image3DModal } from "../3D/image3dmodal";

interface IFrontInfoModalProps {
    poly: Polyglot;
    sprocket: ISprocket;
    sprocketInfo: IFrontSprocketInfo;
    show: boolean;
    onHide: any;
}

interface IFrontInfoModalState {
    has3D: boolean;
    show3D: boolean;
    showImage: boolean;
}

export class FrontInfoModal extends React.Component<IFrontInfoModalProps, IFrontInfoModalState> {

    private imageBase: string = "https://service.afam.com/webshop/images/sprockets/";

    constructor(props: IFrontInfoModalProps) {
        super(props);
