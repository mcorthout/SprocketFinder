...
import { FrontShapeSelector } from ".";

interface IFrontPitchSelectorProps {
    poly: Polyglot;
    language: string;
    thickness: number;
}
...
interface IFrontPitchSelectorState {
    selectedIndex: number;
}

export class FrontPitchSelector extends React.Component<IFrontPitchSelectorProps, IFrontPitchSelectorState> {
    ...
    constructor(props: IFrontPitchSelectorProps) {
        super(props);
    ...
    public componentWillReceiveProps(nextProps: IFrontPitchSelectorProps) {
